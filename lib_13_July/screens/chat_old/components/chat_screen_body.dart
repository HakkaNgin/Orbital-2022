...
//       DatabaseMethods().getUserChats(widget.currentUserId).then((chats) {
//         setState(() {
//           chatRooms = chats;
...
//     // });
//
//     chatRooms = DatabaseMethods().getUserChats(widget.currentUserId);
...
//                 itemCount: DatabaseMethods().getUserChats(widget.currentUserId).docs.length,
//                 // itemCount: 1,
